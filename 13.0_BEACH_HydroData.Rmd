...
write.table(rain_tss, "Data/BEACH/rain_mmday.tss", sep="\t", row.names = F)
```
...
write.table(DischQm3_tss, "Data/BEACH/disch_m3day.tss", sep="\t", row.names = F)

# Qmm/day
DischQmm_tss = qDay[,c("time", "Q.mm")] 
write.table(DischQmm_tss, "Data/BEACH/disch_mmday.tss", sep="\t", row.names = F)
```
