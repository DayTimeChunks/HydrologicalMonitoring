...
colnames(filtersIso)[colnames(filtersIso) == "DD13...31.21."] <- "DD13"
...
#       as.POSIXct('2016-04-05 15:08:00' , tz="EST"),
       ...
       as.POSIXct('2016-05-10 00:06:00' , tz="EST"))

Appl.Mass.g = c(9497.87, 4744.571, 4982.038)
...
out.CoIs$timeSinceApp <- round(out.CoIs$timeSinceApp/24, 1) 
