...
south_first <- 
  DGplotConc*((15022.6+15697.6)/Sarea_eff)+ # Friess
  DGplotConc*(54313.801/Sarea_eff) # Mathis
  
north_second <- 
  north_first+
  MGplotConc.Corn*(9452.500/Narea_eff+ # Kopp
                     13776.500/Narea_eff+
                     17448.600/Narea_eff)
talweg_second <- 
  talweg_first+
...
south_second <- 
  south_first+
  MGplotConc.Beet*(24869.100/Sarea_eff)

talweg_third <- 
  talweg_second+DGplotConc*(9383.640/Tarea_eff)

north_fourth <- 
  north_second+DGplotConc*(17140.801/Narea_eff)
