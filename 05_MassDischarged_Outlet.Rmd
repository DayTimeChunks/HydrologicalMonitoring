...
###############
# SD for MES S-meto mass (mg) 
##############
# mg = Conc. [mu.g s-meto / g MES] * MES.sd [mg/L] * Vol [m3] * [10^3 L/1 m3]* [mg/10^3mug] 
# out.CoIs$Conc.Solids.mug.gMES * out.CoIs$MES.sd * out.CoIs$Volume.m3... check calculation
...
# Need to update this :
out.CoIs$SimOutSmeto.g.SD = out.CoIs$DissSmeto.g.SD

mw.SM <- 283.796 # g/mol
mw.MOXA <- 279.33 # g/ml
mw.MESA <- 329.1 # g/mol
out.CoIs$SimMELsm.g <- 
  out.CoIs$SimOutSmeto.g + 
  out.CoIs$SimOutOXA.g * (mw.SM/mw.MOXA) +
  out.CoIs$SimOutESA.g * (mw.SM/mw.MESA)

# How to sum a standard deviation
# http://stats.stackexchange.com/questions/25848/how-to-sum-a-standard-deviation
out.CoIs$SimMELsm.g.SD <- 
  sqrt((out.CoIs$SimOutSmeto.g.SD^2 +
