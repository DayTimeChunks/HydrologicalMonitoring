...
# Base plot
  ...
  fg <-
    ...
    #stat_ellipse(aes(x=xvar,y=yvar, fill= Cluster),
    #           geom="polygon", level=0.90, alpha=0.2) +
    theme_bw() +
...
ggsave(fg, filename = "Images/PCA_events.png", width = 8, height = 5, units = "in", scale = 1)
```
