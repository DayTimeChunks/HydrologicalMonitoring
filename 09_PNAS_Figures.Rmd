...
soilsOut$BulkCatch.d13 <- ifelse(is.na(soils$comp.d13C.SD.North), NA, 
                                 ifelse(is.na(soils$comp.d13C.SD.Talweg), NA,
                                              ifelse(is.na(soils$comp.d13C.SD.South), NA, soilsOut$BulkCatch.d13)
                                        )
                                 )
...
```{r}
# Omit cumulateive variables for dates 
# in which no soil sample was made  
remainOnSampleDay <- na.omit(soilsRemainMass)
...
prctMB$variable <- factor(prctMB$variable, levels = c( "Unknown", "Persist.Prct" , "SM.PrctOut", "TPs.PrctOut"))
