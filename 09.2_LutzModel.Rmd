...
events <- events[c("Hrs", "max.mm", "measure", "SD" ,  
                   "EventLabel", 
                   "Label", "Approach", "HasLabel")]
names(events) = c("Duration.hr", "mm.hr", "measure", "SD" ,  
                  "EventLabel", 
...
Event =  rep("Simulation", reps)
HasLabel = rep(NA, reps)
Approach <- rep("Simulation (Lutz et al., 2013)", reps)

eventLutz <- data.frame(Duration.hr, mm.hr, measure, SD, 
                        EventLabel, 
                        Event, Approach, HasLabel)
...
LutzEvents <- ggplot(data = allEvents, aes(x= Duration.hr, y=measure) )+
  # theme_bw() +
  theme_minimal() +
  theme(text = element_text(size=17)) + 
  geom_errorbar(data = allEvents, aes(ymin = measure-SD, ymax = measure+SD, colour = Event),
...
#ggsave(LutzEvents, filename = "images/LutzEvents.png", width = 8, height = 5, units = "in", scale = 1)
# MAC
#  ggsave(LutzEvents, 
#    filename = "/Users/DayTightChunks/Documents/PhD/Writeups/PNAS/Alteck_PNAS_LaTeX/images/lutz.pdf", 
