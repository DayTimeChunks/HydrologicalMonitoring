...
Event =  rep("Model (Lutz et al., 2013)", reps)
Cluster =  NA

HasLabel = rep(NA, reps)
Approach <- rep("Model (Lutz et al., 2013)", reps)
...
LutzEvents <- ggplot(data = allEvents, 
  ...
  geom_errorbar(data = allEvents, 
                ...
                size=0.2) +
  geom_line(data=subset(allEvents, Event == "Model (Lutz et al., 2013)" ), aes(colour = Event), linetype = "dashed") +
