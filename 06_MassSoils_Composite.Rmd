...
weeklySoilIso  = read.csv2("Data/SoilCompIsotopes_W1toW15ng.csv", header = TRUE)
...
weeklySoilIso <- subset(weeklySoilIso, DD13 > 0 & DD13 < 10 & ngC >= 2)
...
For non-measured plots, the soil concentration and isotope measured at the neareast transect is assumed. The total area for each transect is calculated and shown below. 
...
write.csv2(comp.CoIs, 
           'Data/WeeklySoils_Rng.csv', row.names = F)
