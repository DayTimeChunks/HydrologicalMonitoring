...
weeklySoilIso <- weeklySoilIso[complete.cases(weeklySoilIso),]
# weeklySoilIso <- subset(weeklySoilIso, DD13 < 10) # & ngC > 5)
...
sum(isoCompSummary$N_ngC == 2)
sum(isoCompSummary$N_ngC == 3)
...
# Lab enrichment: Alteck
epsilon_max # +/- 0.3 (@ 20C, 20% vwc)
epsilon_min # +/- 0.2 (@ 20C, 40% vwc)
