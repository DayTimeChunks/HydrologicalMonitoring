...
clusterGroups = cutree(waterXY.hw.nona, k = 3)

# No. of rows/observations
length(clusterGroups) == lengths(waterXY.hell.nona)[1]
  
head(waterXY.hw.nona)

head(waterXY.hell.nona)


bindedGroups <- cbind2(clusterGroups, waterXY.hell.nona)
View(bindedGroups)
View(waterXY.hell.nona)
```

## Extracting labels by group
