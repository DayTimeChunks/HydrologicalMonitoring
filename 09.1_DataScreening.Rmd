...
wstidier2 = subset(wstidier, SD <= 0.54) #& Source != "Bulk"  ) #& Date < as.POSIXct('2016-06-14 08:04:00'))
...
wsALL_field <- ggplot(data = wstidier2, aes(x = Date, y = measure, group = Source) )+ 
  ...
  guides(col = guide_legend(order = 1,
         ...
         size = guide_legend(order = 3, 
                             ...
                             nrow=2, title.position = "top", title.vjust = .26
                              ))# +
...
label2 <- substitute(paste(epsilon ["field"] , " = ", epsilon_f, "\u00B1", "0.2" ,"\u2030"),
...
wsALL <- ggdraw() +
  ...
  draw_label(label2, x= .85, y = .2, size = 10) +
  draw_label(label3, x= .92, y = .15, size = 10) +
