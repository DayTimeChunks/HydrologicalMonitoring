...
cofDegField <- as.numeric(coef(model)[2])
...
type <- rep(c("CSIA", "Predicted (half-life)", 
              "CSIA", "Predicted (half-life)", 
              "Mass Balance", 
              "Mass Balance"), 2)
...
waterClean <- subset(waters, Sampled == "Sampled" & SD.d13C <= 0.5 )
