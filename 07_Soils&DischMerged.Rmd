...
outlet <- outlet[, c("ti", "WeekSubWeek", "Event", "timeSinceApp", "timeSinceApp.NoSo",
                     "diss.d13C", "SD.d13C", 
...
soils.N <- soils.N[, c("Date.ti", "B.mean.comp",  "B.max.comp",  "B.min.comp",  "MassSoil.g", "MassSoil.g.SD",
                       "comp.d13C", "comp.d13C.SD", # "comp.d13C.SE", 
                       "ID", "Area.N", "Area.T", "Area.S" )]

colnames(soils.N) <- c("ti",  "B.mean.comp.North", "B.max.comp.North", "B.min.comp.North", 
...
soils.T <- soils.T[, c("Date.ti", "B.mean.comp",  "B.max.comp",  "B.min.comp", "MassSoil.g", "MassSoil.g.SD",
                       "comp.d13C", "comp.d13C.SD", # "comp.d13C.SE", 
                       "ID")]

colnames(soils.T) <- c("ti",  "B.mean.comp.Talweg", "B.max.comp.Talweg", "B.min.comp.Talweg", 
...
soils.S <- soils.S[, c("Date.ti", "B.mean.comp",  "B.max.comp",  "B.min.comp", "MassSoil.g", "MassSoil.g.SD",
                       "comp.d13C", "comp.d13C.SD", # "comp.d13C.SE", 
                       "ID" )]
colnames(soils.S) <- c("ti",  "B.mean.comp.South", "B.max.comp.South", "B.min.comp.South", 
...
d13Co
soilsOut$BulkCatch.DD13 <-  (soilsOut$BulkCatch.d13 - (d13Co))  

# Mean epsilon (# Alteck)
soilsOut$f.mean.bulk <- 
  ((10^(-3)*soilsOut$BulkCatch.d13 + 1)/(10^(-3)*d13Co + 1))^(1000/(epsilon_mean))
soilsOut$f.mean.bulk.Field <- 
  ((10^(-3)*soilsOut$BulkCatch.d13 + 1)/(10^(-3)*d13Co + 1))^(1000/(epsilonField_mean))

soilsOut$f.min.bulk <- 
  ((10^(-3)*soilsOut$BulkCatch.d13 + 1)/(10^(-3)*d13Co + 1))^(1000/(epsilon_max))
soilsOut$f.min.bulk.Field <- 
  ((10^(-3)*soilsOut$BulkCatch.d13 + 1)/(10^(-3)*d13Co + 1))^(1000/(epsilonField_max))

soilsOut$f.max.bulk <- 
  ((10^(-3)*soilsOut$BulkCatch.d13 + 1)/(10^(-3)*d13Co + 1))^(1000/(epsilon_min))
soilsOut$f.max.bulk.Field <- 
  ((10^(-3)*soilsOut$BulkCatch.d13 + 1)/(10^(-3)*d13Co + 1))^(1000/(epsilonField_min))
...
soilsOut$B.mean.bulk.Field <-
  (1 - soilsOut$f.mean.bulk.Field)*100
soilsOut$B.min.bulk.Field <-
  (1 - soilsOut$f.max.bulk.Field)*100
soilsOut$B.max.bulk.Field <-
  (1 - soilsOut$f.min.bulk.Field)*100
