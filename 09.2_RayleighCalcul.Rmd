...
soils$Area.Catch <- soils$Area.N + soils$Area.S + soils$Area.T
soils$dM.g.Bulk <- (soils$iniCo.Bulk*rho*soils$Area.Catch*depth - soils$BulkCatch.Conc*rho*soils$Area.Catch*depth)*1/10^6
...
soils$Mdeg.g.Bulk <- soils$dM.g.Bulk*soils$Bstar.Bulk
...
soils$PrctDeg.Bulk <- (soils$Mdeg.g.Bulk /soils$CumAppMass.g)*100 # Bulk deg. rel. to app. mass (shouldbe = Elsner Bulk)


soils$DiffToB.breukelen <- soils$Bprct.Bulk - soils$PrctDeg
soils$DiffToB.elsner <- soils$Belsner.Bulk - soils$PrctDeg.Bulk
#soils$Mdeg.g.N <- ifelse(is.na(soils$Mdeg.g.N), 0, soils$Mdeg.g.N)
#soils$Mdeg.g.T <- ifelse(is.na(soils$Mdeg.g.T), 0, soils$Mdeg.g.T)
#soils$Mdeg.g.S <- ifelse(is.na(soils$Mdeg.g.S), 0, soils$Mdeg.g.S)
#soils$SumDeg.g.N <- cumsum(soils$Mdeg.g.N)
#soils$SumDeg.g.T <- cumsum(soils$Mdeg.g.T)
#soils$SumDeg.g.S <- cumsum(soils$Mdeg.g.S)
